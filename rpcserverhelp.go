...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, ohmcd, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in ohmc as the value",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (ohmcd extension)",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in ohmc/KB",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in ohmc/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in ohmc/KB",
	...
	"gettxoutresult-value":         "The transaction amount in ohmc",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (ohmcd does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown ohmcd.",
	"stop--result0":  "The string 'ohmcd stopping.'",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this ohmcd instance) and when such a transaction first appears in a newly-attached block.",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*ohmcjson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*ohmcjson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"generate":              {(*[]string)(nil)},
	"getaddednodeinfo":      {(*[]string)(nil), (*[]ohmcjson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*ohmcjson.GetBestBlockResult)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*ohmcjson.GetBlockVerboseResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*ohmcjson.GetBlockHeaderVerboseResult)(nil)},
	"getblocktemplate":      {(*ohmcjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getblockchaininfo":     {(*ohmcjson.GetBlockChainInfoResult)(nil)},
	...
	"getinfo":               {(*ohmcjson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*ohmcjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*ohmcjson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*ohmcjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]ohmcjson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*ohmcjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*ohmcjson.TxRawResult)(nil)},
	"gettxout":              {(*ohmcjson.GetTxOutResult)(nil)},
	"node":                  nil,
	"help":                  {(*string)(nil), (*string)(nil)},
	"ping":                  nil,
	"searchrawtransactions": {(*string)(nil), (*[]ohmcjson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"uptime":                {(*int64)(nil)},
	"validateaddress":       {(*ohmcjson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]ohmcjson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":              nil,
	"session":                   {(*ohmcjson.SessionResult)(nil)},
	"notifyblocks":              nil,
	...
	"stopnotifyspent":           nil,
	"rescan":                    nil,
	"rescanblocks":              {(*[]ohmcjson.RescannedBlock)(nil)},
}
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := ohmcjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := ohmcjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
