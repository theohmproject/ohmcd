...
reason, the ohmcd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire ohmcd
...
One of the major design goals of all core ohmcd packages is to aim for complete
...
commits](https://github.com/ohmcsuite/ohmcd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into ohmcd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/ohmcsuite/ohmcd/graphs/contributors)!
...
[ISC license](https://github.com/ohmcsuite/ohmcd/blob/master/LICENSE).  This is
the same license as all of the code in the ohmcd suite.
