...
type blockProgressLogger struct {
	...
	subsystemLogger ohmclog.Logger
...
func newBlockProgressLogger(progressMessage string, logger ohmclog.Logger) *blockProgressLogger {
...
func (b *blockProgressLogger) LogBlockHeight(block *ohmcutil.Block) {
	b.Lock()
	defer b.Unlock()
