...
import (
	...
	peerpkg "github.com/ohmcsuite/ohmcd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*ohmcutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *ohmcutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *ohmcutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *ohmcutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
