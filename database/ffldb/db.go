...
import (
	...
	"github.com/ohmcsuite/ohmcd/database/internal/treap"
	"github.com/ohmcsuite/ohmcd/wire"
	"github.com/ohmcsuite/ohmcutil"
	"github.com/ohmcsuite/goleveldb/leveldb"
	"github.com/ohmcsuite/goleveldb/leveldb/comparer"
	ldberrors "github.com/ohmcsuite/goleveldb/leveldb/errors"
	"github.com/ohmcsuite/goleveldb/leveldb/filter"
	"github.com/ohmcsuite/goleveldb/leveldb/iterator"
	"github.com/ohmcsuite/goleveldb/leveldb/opt"
	"github.com/ohmcsuite/goleveldb/leveldb/util"
)
...
//
// This function is part of the database.Tx interface implementation.
func (tx *transaction) StoreBlock(block *ohmcutil.Block) error {
	// Ensure transaction state is valid.
