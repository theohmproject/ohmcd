...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*ohmcutil.Block, error) {
	...
	blocks := make([]*ohmcutil.Block, 0, 256)
	genesis := ohmcutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
