...
var (
	...
	defaultDataDir  = filepath.Join(ohmcdHomeDir, "data")
...
type config struct {
	DataDir        string `short:"b" long:"datadir" description:"Location of the ohmcd data directory"`
	...
	UseGoOutput    bool   `short:"g" long:"gooutput" description:"Display the candidates using Go syntax that is ready to insert into the ohmcchain checkpoint list"`
}
...
// time of writing, ohmcd currently places blocks for testnet version 3 in the
