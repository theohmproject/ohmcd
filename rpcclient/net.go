...
func (c *Client) AddNodeAsync(host string, command AddNodeCommand) FutureAddNodeResult {
	cmd := ohmcjson.NewAddNodeCmd(host, ohmcjson.AddNodeSubCmd(command))
...
func (c *Client) NodeAsync(command ohmcjson.NodeSubCmd, host string,
	connectSubCmd *string) FutureNodeResult {
	cmd := ohmcjson.NewNodeCmd(command, host, connectSubCmd)
	return c.sendCmd(cmd)
}
...
func (c *Client) Node(command ohmcjson.NodeSubCmd, host string,
...
func (r FutureGetAddedNodeInfoResult) Receive() ([]ohmcjson.GetAddedNodeInfoResult, error) {
	...
	var nodeInfo []ohmcjson.GetAddedNodeInfoResult
...
func (c *Client) GetAddedNodeInfoAsync(peer string) FutureGetAddedNodeInfoResult {
	cmd := ohmcjson.NewGetAddedNodeInfoCmd(true, &peer)
	return c.sendCmd(cmd)
}
...
// peers.
func (c *Client) GetAddedNodeInfo(peer string) ([]ohmcjson.GetAddedNodeInfoResult, error) {
...
func (c *Client) GetAddedNodeInfoNoDNSAsync(peer string) FutureGetAddedNodeInfoNoDNSResult {
	cmd := ohmcjson.NewGetAddedNodeInfoCmd(false, &peer)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetConnectionCountAsync() FutureGetConnectionCountResult {
	cmd := ohmcjson.NewGetConnectionCountCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetPeerInfoResult) Receive() ([]ohmcjson.GetPeerInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var peerInfo []ohmcjson.GetPeerInfoResult
...
func (c *Client) GetPeerInfoAsync() FutureGetPeerInfoResult {
	cmd := ohmcjson.NewGetPeerInfoCmd()
	return c.sendCmd(cmd)
}

// GetPeerInfo returns data about each connected network peer.
func (c *Client) GetPeerInfo() ([]ohmcjson.GetPeerInfoResult, error) {
...
// traffic statistics.
func (r FutureGetNetTotalsResult) Receive() (*ohmcjson.GetNetTotalsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var totals ohmcjson.GetNetTotalsResult
...
func (c *Client) GetNetTotalsAsync() FutureGetNetTotalsResult {
	cmd := ohmcjson.NewGetNetTotalsCmd()
	return c.sendCmd(cmd)
}

// GetNetTotals returns network traffic statistics.
func (c *Client) GetNetTotals() (*ohmcjson.GetNetTotalsResult, error) {
