...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := ohmcjson.NewGetBestBlockHashCmd()
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := ohmcjson.NewGetBlockCmd(hash, ohmcjson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockVerboseResult) Receive() (*ohmcjson.GetBlockVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockResult ohmcjson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := ohmcjson.NewGetBlockCmd(hash, ohmcjson.Bool(true), nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash) (*ohmcjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := ohmcjson.NewGetBlockCmd(hash, ohmcjson.Bool(true), ohmcjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*ohmcjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := ohmcjson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := ohmcjson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockChainInfoResult) Receive() (*ohmcjson.GetBlockChainInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var chainInfo ohmcjson.GetBlockChainInfoResult
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := ohmcjson.NewGetBlockChainInfoCmd()
	return c.sendCmd(cmd)
}
...
// of the main chain.
func (c *Client) GetBlockChainInfo() (*ohmcjson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := ohmcjson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderResult {
	...
	cmd := ohmcjson.NewGetBlockHeaderCmd(hash, ohmcjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*ohmcjson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var bh ohmcjson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	...
	cmd := ohmcjson.NewGetBlockHeaderCmd(hash, ohmcjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (*ohmcjson.GetBlockHeaderVerboseResult, error) {
...
// its hash.
func (r FutureGetMempoolEntryResult) Receive() (*ohmcjson.GetMempoolEntryResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var mempoolEntryResult ohmcjson.GetMempoolEntryResult
...
func (c *Client) GetMempoolEntryAsync(txHash string) FutureGetMempoolEntryResult {
	cmd := ohmcjson.NewGetMempoolEntryCmd(txHash)
	return c.sendCmd(cmd)
}

// GetMempoolEntry returns a data structure with information about the
// transaction in the memory pool given its hash.
func (c *Client) GetMempoolEntry(txHash string) (*ohmcjson.GetMempoolEntryResult, error) {
...
func (c *Client) GetRawMempoolAsync() FutureGetRawMempoolResult {
	cmd := ohmcjson.NewGetRawMempoolCmd(ohmcjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]ohmcjson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]ohmcjson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync() FutureGetRawMempoolVerboseResult {
	cmd := ohmcjson.NewGetRawMempoolCmd(ohmcjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose() (map[string]ohmcjson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) EstimateFeeAsync(numBlocks int64) FutureEstimateFeeResult {
	cmd := ohmcjson.NewEstimateFeeCmd(numBlocks)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := ohmcjson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int32) FutureVerifyChainResult {
	cmd := ohmcjson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int32) FutureVerifyChainResult {
	cmd := ohmcjson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*ohmcjson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *ohmcjson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := ohmcjson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*ohmcjson.GetTxOutResult, error) {
...
// NOTE: This is a ohmcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureRescanBlocksResult) Receive() ([]ohmcjson.RescannedBlock, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanBlocksResult []ohmcjson.RescannedBlock
...
func (c *Client) RescanBlocksAsync(blockHashes []chainhash.Hash) FutureRescanBlocksResult {
	...
	cmd := ohmcjson.NewRescanBlocksCmd(strBlockHashes)
	return c.sendCmd(cmd)
}
...
// NOTE: This is a ohmcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) RescanBlocks(blockHashes []chainhash.Hash) ([]ohmcjson.RescannedBlock, error) {
...
func (c *Client) InvalidateBlockAsync(blockHash *chainhash.Hash) FutureInvalidateBlockResult {
	...
	cmd := ohmcjson.NewInvalidateBlockCmd(hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash,
	...
	cmd := ohmcjson.NewGetCFilterCmd(hash, filterType)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash,
	...
	cmd := ohmcjson.NewGetCFilterHeaderCmd(hash, filterType)
	return c.sendCmd(cmd)
}
