...
func (r FutureGetRawTransactionResult) Receive() (*ohmcutil.Tx, error) {
	...
	return ohmcutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := ohmcjson.NewGetRawTransactionCmd(hash, ohmcjson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*ohmcutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*ohmcjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult ohmcjson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := ohmcjson.NewGetRawTransactionCmd(hash, ohmcjson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*ohmcjson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*ohmcjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := ohmcjson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*ohmcjson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []ohmcjson.TransactionInput,
	amounts map[ohmcutil.Address]ohmcutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.Toohmc()
	}
	cmd := ohmcjson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime)
	return c.sendCmd(cmd)
}

// CreateRawTransaction returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawTransaction(inputs []ohmcjson.TransactionInput,
	amounts map[ohmcutil.Address]ohmcutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	cmd := ohmcjson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	return c.sendCmd(cmd)
}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult ohmcjson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := ohmcjson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []ohmcjson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := ohmcjson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []ohmcjson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := ohmcjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []ohmcjson.RawTxInput, privKeysWIF []string,
	...
	cmd := ohmcjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		ohmcjson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address ohmcutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
	addr := address.EncodeAddress()
	verbose := ohmcjson.Int(0)
	cmd := ohmcjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address ohmcutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*ohmcjson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*ohmcjson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address ohmcutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address ohmcutil.Address, skip,
	count int, includePrevOut, reverse bool, filterAddrs []string) ([]*ohmcjson.SearchRawTransactionsResult, error) {
...
func (r FutureDecodeScriptResult) Receive() (*ohmcjson.DecodeScriptResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var decodeScriptResult ohmcjson.DecodeScriptResult
...
func (c *Client) DecodeScriptAsync(serializedScript []byte) FutureDecodeScriptResult {
	...
	cmd := ohmcjson.NewDecodeScriptCmd(scriptHex)
	return c.sendCmd(cmd)
}

// DecodeScript returns information about a script given its serialized bytes.
func (c *Client) DecodeScript(serializedScript []byte) (*ohmcjson.DecodeScriptResult, error) {
