...
//
// NOTE: This is a ohmcd extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := ohmcjson.NewDebugLevelCmd(levelSpec)
...
func (r FutureListAddressTransactionsResult) Receive() ([]ohmcjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a ohmcd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []ohmcutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := ohmcjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a ohmcwallet extension.
func (c *Client) ListAddressTransactions(addresses []ohmcutil.Address, account string) ([]ohmcjson.ListTransactionsResult, error) {
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int32, error) {
	...
	var bestBlock ohmcjson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := ohmcjson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := ohmcjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := ohmcjson.NewGetHeadersCmd(locators, hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := ohmcjson.NewExportWatchingWalletCmd(&account, ohmcjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by ohmcwallet to enable a wallet which does not have the private keys
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*ohmcjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session ohmcjson.SessionResult
...
//
// NOTE: This is a ohmcsuite extension.
...
//
// NOTE: This is a ohmcsuite extension.
func (c *Client) Session() (*ohmcjson.SessionResult, error) {
...
// NOTE: This is a ohmcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]ohmcjson.VersionResult,
	error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	...
	var vr map[string]ohmcjson.VersionResult
...
// NOTE: This is a ohmcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) Version() (map[string]ohmcjson.VersionResult, error) {
