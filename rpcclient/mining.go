...
func (c *Client) GenerateAsync(numBlocks uint32) FutureGenerateResult {
	cmd := ohmcjson.NewGenerateCmd(numBlocks)
...
func (c *Client) GetGenerateAsync() FutureGetGenerateResult {
	cmd := ohmcjson.NewGetGenerateCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetGenerateAsync(enable bool, numCPUs int) FutureSetGenerateResult {
	cmd := ohmcjson.NewSetGenerateCmd(enable, &numCPUs)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHashesPerSecAsync() FutureGetHashesPerSecResult {
	cmd := ohmcjson.NewGetHashesPerSecCmd()
	return c.sendCmd(cmd)
}
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*ohmcjson.GetMiningInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoResult ohmcjson.GetMiningInfoResult
...
func (c *Client) GetMiningInfoAsync() FutureGetMiningInfoResult {
	cmd := ohmcjson.NewGetMiningInfoCmd()
	return c.sendCmd(cmd)
}

// GetMiningInfo returns mining information.
func (c *Client) GetMiningInfo() (*ohmcjson.GetMiningInfoResult, error) {
...
func (c *Client) GetNetworkHashPSAsync() FutureGetNetworkHashPS {
	cmd := ohmcjson.NewGetNetworkHashPSCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS2Async(blocks int) FutureGetNetworkHashPS {
	cmd := ohmcjson.NewGetNetworkHashPSCmd(&blocks, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS3Async(blocks, height int) FutureGetNetworkHashPS {
	cmd := ohmcjson.NewGetNetworkHashPSCmd(&blocks, &height)
	return c.sendCmd(cmd)
}
...
// data to work on.
func (r FutureGetWork) Receive() (*ohmcjson.GetWorkResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result ohmcjson.GetWorkResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWorkAsync() FutureGetWork {
	cmd := ohmcjson.NewGetWorkCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetWork() (*ohmcjson.GetWorkResult, error) {
...
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := ohmcjson.NewGetWorkCmd(&data)
	return c.sendCmd(cmd)
}
...
func (c *Client) SubmitBlockAsync(block *ohmcutil.Block, options *ohmcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
	...
	cmd := ohmcjson.NewSubmitBlockCmd(blockHex, options)
	return c.sendCmd(cmd)
}

// SubmitBlock attempts to submit a new block into the bitcoin network.
func (c *Client) SubmitBlock(block *ohmcutil.Block, options *ohmcjson.SubmitBlockOptions) error {
