...
/*
ohmcd is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means ohmcd will work 'out of
...
parsed when ohmcd starts up.  By default, the configuration file is located at
~/.ohmcd/ohmcd.conf on POSIX-style operating systems and %LOCALAPPDATA%\ohmcd\ohmcd.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in ohmc/kB to be
