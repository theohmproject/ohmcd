...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr ohmcutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*ohmcutil.Tx, error) {
...
func CreateBlock(prevBlock *ohmcutil.Block, inclusionTxs []*ohmcutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr ohmcutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*ohmcutil.Block, error) {
	...
	blockTxns := []*ohmcutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := ohmcutil.NewBlock(&block)
