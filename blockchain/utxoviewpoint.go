...
func (view *UtxoViewpoint) AddTxOut(tx *ohmcutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *ohmcutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *ohmcutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *ohmcutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *ohmcutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *ohmcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *ohmcutil.Tx) (*UtxoViewpoint, error) {
