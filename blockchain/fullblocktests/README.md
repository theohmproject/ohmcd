...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ohmcsuite/ohmcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/ohmcsuite/ohmcd/blockchain/fullblocktests
```
