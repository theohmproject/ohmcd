...
func GetBlockWeight(blk *ohmcutil.Block) int64 {
...
func GetTransactionWeight(tx *ohmcutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *ohmcutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
