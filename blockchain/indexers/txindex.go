...
func dbAddTxIndexEntries(dbTx database.Tx, block *ohmcutil.Block, blockID uint32) error {
...
func dbRemoveTxIndexEntries(dbTx database.Tx, block *ohmcutil.Block) error {
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) ConnectBlock(dbTx database.Tx, block *ohmcutil.Block,
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) DisconnectBlock(dbTx database.Tx, block *ohmcutil.Block,
	stxos []blockchain.SpentTxOut) error {
