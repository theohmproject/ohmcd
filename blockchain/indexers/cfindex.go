...
import (
	...
	"github.com/ohmcsuite/ohmcutil/gcs"
	"github.com/ohmcsuite/ohmcutil/gcs/builder"
)
...
func storeFilter(dbTx database.Tx, block *ohmcutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *ohmcutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *ohmcutil.Block,
