...
type sigCacheEntry struct {
	sig    *ohmcec.Signature
	pubKey *ohmcec.PublicKey
}
...
func (s *SigCache) Exists(sigHash chainhash.Hash, sig *ohmcec.Signature, pubKey *ohmcec.PublicKey) bool {
	s.RLock()
...
func (s *SigCache) Add(sigHash chainhash.Hash, sig *ohmcec.Signature, pubKey *ohmcec.PublicKey) {
	s.Lock()
	defer s.Unlock()
