...
func (msg *MsgAddr) ohmcDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count > MaxAddrPerMsg {
		...
		return messageError("MsgAddr.ohmcDecode", str)
	}
...
// This is part of the Message interface implementation.
func (msg *MsgAddr) ohmcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	...
	if pver < MultipleAddressVersion && count > 1 {
		...
		return messageError("MsgAddr.ohmcEncode", str)
