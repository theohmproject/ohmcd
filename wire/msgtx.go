...
func (msg *MsgTx) ohmcDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count == 0 && enc == WitnessEncoding {
		...
		if flag[0] != 0x01 {
			...
			return messageError("MsgTx.ohmcDecode", str)
		}
...
// the Version field in the transaction.  This function differs from ohmcDecode
// in that ohmcDecode decodes from the bitcoin wire protocol as it was sent
...
func (msg *MsgTx) ohmcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// the transaction.  This function differs from ohmcEncode in that ohmcEncode
...
func (msg *MsgTx) Serialize(w io.Writer) error {
	...
	//
	// Passing a encoding type of WitnessEncoding to ohmcEncode for MsgTx
