// Copyright (c) 2018 The ohmcsuite developers
...
func (msg *MsgCFCheckpt) ohmcDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
	// Read filter type
...
// This is part of the Message interface implementation.
func (msg *MsgCFCheckpt) ohmcEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
	// Write filter type
