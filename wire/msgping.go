...
func (msg *MsgPing) ohmcDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgPing) ohmcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	// There was no nonce for BIP0031Version and earlier.
	// NOTE: > is not a mistake here.  The BIP0031 was defined as AFTER
	// the version unlike most others.
	if pver > BIP0031Version {
