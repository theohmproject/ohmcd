...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.ohmcEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.ohmcDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.ohmcEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.ohmcDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.ohmcEncode(w, test.pver, BaseEncoding)
		...
		err = msg.ohmcDecode(r, test.pver, BaseEncoding)
