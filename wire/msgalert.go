...
func (msg *MsgAlert) ohmcDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	var err error
...
// This is part of the Message interface implementation.
func (msg *MsgAlert) ohmcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	var err error
	...
	if slen == 0 {
		return messageError("MsgAlert.ohmcEncode", "empty serialized payload")
	}
