...
const DefaultUserAgent = "/ohmcwire:0.5.0/"
...
func (msg *MsgVersion) ohmcDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	buf, ok := r.(*bytes.Buffer)
	if !ok {
		return fmt.Errorf("MsgVersion.ohmcDecode reader is not a " +
			"*bytes.Buffer")
	}
...
// This is part of the Message interface implementation.
func (msg *MsgVersion) ohmcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
