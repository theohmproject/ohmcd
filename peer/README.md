...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ohmcsuite/ohmcd/peer)
...
```bash
$ go get -u github.com/ohmcsuite/ohmcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/ohmcsuite/ohmcd/peer#example-package--NewOutboundPeer)  
